...
// // Uncomment the following code for the REPL after implementing the execution
...
// String help, boolean requiresParameter,
...
// if (cmd == null) {
// printRepl("Unknown command: " + str + ". Type \"help\" to get a list of
// available commands");
// result = false;
// } else {
// try {
...
// commands.put("help", new Command("help", this, (param) -> false,
// commands.keySet().toString(), false, ""));
// // for command "message" we get the message passed as parameter, we need to
// add
// // the trigger for the listener
